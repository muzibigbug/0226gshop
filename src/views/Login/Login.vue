    ...
    <section class="loginContainer">
      <div class="loginInner">
        <div class="login_header">
          <h2 class="login_logo">muzidigbig外卖</h2>
          ...
          <form @submit.prevent="login">
            <div :class="{on: loginWay}">
              ...
              <section class="login_verification">
                <input type="number" maxlength="8" placeholder="验证码" v-model.trim="code" />
              </section>
            ...
            <div :class="{on: !loginWay}">
              <section>
                ...
                <section class="login_verification">
                  ...
                  >
                    <div class="switch_circle" :class="{switchTranform: showPwd}"></div>
...
export default {
  ...
  data() {
    return {
      ...
      captcha: "", //图形验证码
      alertText: "错误提示", // 提示文本
      alertShow: false, //是否显示提示组件
      captcha: "" // 请求验证图片
    };
  },
  mounted() {
    // reqCaptcha().then((data) => {
    //   this.captcha = data
    //   console.log(data)
    // });
  },
    ...
    async login() {
      ...
      if (this.loginWay) {
        ...
        if (!this.rightPhone) {
          ...
          // 验证码不正确/验证码为6为数字
          this.showAlert("验证码不正确/验证码为6为数字");
          return;
        }
        //发送ajax短信登录
